...
3. The Arena automatically discovers your locally pulled models on `http://127.0.0.1:11434`.
...
**A**: **No, never.** DUAL-AI-ARENA has **zero telemetry** and zero hosted backends. All computation runs locally on your machine (`127.0.0.1`). If you use Ollama, zero bytes ever touch the internet.
...
**A**: Press `Ctrl + Shift + A` anywhere in the app, or double-click the **`// DUAL AI MID ARENA`** logo.
